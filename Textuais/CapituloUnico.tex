...
A figura~\ref{fig:figura1} mostra a representação de uma árvore octree e seus filhos.
\begin{figure}[htb]
  \centering
...
\begin{figure}[htb]
  \centering
	...
	\includegraphics[scale=0.5]{Imagens/Figura_2.4.png} %width=\textwidth
	\legend{Fonte: \cite{ericson2004real}. }
\end{figure}
...
\begin{lstlisting}[frame=single,caption=Modelagem prévia para fase ampla\label{ps:broadphase}]
class Fase_ampla{
